...
#define ECS_IOCTL_READ		_IOWR('c', 0x0b, char[AKM_SENSOR_CONF_SIZE])
#define ECS_IOCTL_WRITE		_IOW('c', 0x0c, char[AKM_SENSOR_CONF_SIZE])
#define ECS_IOCTL_RESET		_IO('c', 0x0d)
#define ECS_IOCTL_SET_MODE	_IOW('c', 0x0e, char)
#define ECS_IOCTL_GETDATA	_IOR('c', 0x0f, char[AKM_SENSOR_DATA_SIZE])
#define ECS_IOCTL_GET_OPEN_STATUS	_IOR('c', 0x10, int)
#define ECS_IOCTL_GET_CLOSE_STATUS	_IOR('c', 0x11, int)
#define ECS_IOCTL_GET_OSENSOR_STATUS	_IOR('c', 0x12, int)
